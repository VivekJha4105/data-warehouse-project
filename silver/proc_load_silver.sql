...
BEGIN 
	...
	BEGIN TRY 
		...
		TRUNCATE TABLE silver.crm_cust_info;
		PRINT'>> Inseting Data into Table: silver.crm_prd_info';
		...
		PRINT'>> Inseting Data into Table: silver.crm_sales_details';
	  ...
	  PRINT '--------------------------------------------';
		...
		PRINT'>> Inseting Data into Table: silver.erp_cust_az12';
		...
		PRINT'>> Inseting Data into Table: silver.erp_loc_a101';
		...
		PRINT'>> Inseting Data into Table: silver.erp_px_cat_g1v2';
